// skill exp tiers
export const tier1EXP = 0; // 0-50
export const tier2EXP = 101334; // 50-70
export const tier3EXP = 737628; // 70-80
export const tier4EXP = 1986069; // 80-90
export const tier5EXP = 5346333; // 90-99
export const maxEXPValue = 13034431 // 99+

// combat skills
export const combatSkills = ["attack", "strength", 
    "defense", "range", "magic", "prayer", "hitpoints", "slayer"];

export const skillingSkills = ["cooking", "woodcutting", "fletching", "fishing",
...
// all tob raids
export const tobKC = ["theatre_of_blood", "theatre_of_blood_hard_mode"];
